from espnet2.bin.asr_inference import Speech2Text  as AbeSpeech2Text
...
speech2text = AbeSpeech2Text.from_pretrained(
...
import sys
sys.path.append('/mnt/kiso-qnap2/yuabe/b4/espnet')

from espnet2.bin.asr_inference import Speech2Text as YuabeSpeech2Text
# (Pdb) p(speech2text_kwargs)
...
speech2text_for_lm = YuabeSpeech2Text.from_pretrained(
